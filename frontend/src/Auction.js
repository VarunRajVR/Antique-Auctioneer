  ...
  render() {
    ...
    return (
      <div className="App jumbotron justify">
        ...
        {/* <label>Enter name: </label><br /><input value={this.state.name} onChange={this.handleAuctionNameChange} class="form-control"/><br /><br /> */}
        ...
        <div>
          <form onSubmit={this.submitNewAuction} className="container-sm bg-light bg-gradient	">
            ...
            <label>Title: </label><br /><input value={this.state.title} onChange={this.handleAuctionTitleChange} class="form-control" /><br /><br />
            <label>Description: </label><br /><textarea rows="4" value={this.state.description} onChange={this.handleAuctionDescriptionChange} class="form-control" /><br /><br />
            <label>MSP: </label><br /><input value={this.state.msp} onChange={this.handleAuctionMspChange} class="form-control" /><br /><br />
